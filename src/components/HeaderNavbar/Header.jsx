    ...
    <header className='header-styling d-md-flex'>
      <div className='header-div d-none d-sm-flex pt-3'>
            <ul className='d-flex checktext'>
                <li className='nav-link'><i className="fa-solid fa-check"></i> 74 butiker</li>
                <li className='nav-link'><i className="fa-solid fa-check"></i> Fri frakt till butik</li>
                <li className='nav-link'><i className="fa-solid fa-check"></i> Störst på sprit!</li>
            </ul>
        </div>
